# 🌟 Day of AI — Overview & Curriculum Breakdown

The **Day of AI** is a global **free educational initiative** created by **MIT RAISE** (Responsible AI for Social Empowerment and Education), a collaboration between the **MIT Media Lab** and the **MIT Schwarzman College of Computing**. Its mission is to equip **K–12 students and teachers** with foundational knowledge of artificial intelligence, emphasizing ethical use, hands-on exploration, and digital citizenship.

Day of AI provides **ready-to-use curriculum**, **teacher guides**, and **age-appropriate activities** that schools can run on *any day they choose*. All materials are **completely free**.
...
### **General Program**
- 🌐 **Day of AI Main Website:**  
  https://dayofai.org/

- 📚 **MIT RAISE – Day of AI Curriculum Hub:**  
  https://raise.mit.edu/day-of-ai
...
The links below point directly to the curriculum pages for each group.

---

### 🟦 Elementary School (Grades 3–5)

🔗 **Elementary School Curriculum (MIT RAISE):**  
https://raise.mit.edu/day-of-ai/elementary-school

**Focus:** AI concepts through play, simple examples, early data awareness, safety, and ethics.

#### 1. What Is AI? (Unplugged)
- AI vs. non-AI  
- Activity: “AI or Not AI?”  
- No computers required

#### 2. Machine Learning Basics (Images)
- How computers recognize patterns  
- Activity: Train a simple classifier

#### 3. Data Literacy for Kids
- Labeling, data quality  
- Activity: label small datasets

#### 4. Creative AI
- AI art and stories  
- Ethical reflection

#### 5. Responsible AI for Kids
...
🔗 **Middle School Curriculum (MIT RAISE):**  
https://raise.mit.edu/day-of-ai/middle-school

**Focus:** Hands-on experimentation, foundational machine learning, fairness, bias, and practical applications.

#### 1. Introduction to AI & Machine Learning
- Training vs. testing a model  
- Interactive demos

#### 2. Machine Learning with Text
- Sentiment analysis  
- Word embeddings (simplified)

#### 3. Ethics: Fairness, Bias & Privacy
- Real-world examples  
- Dataset imbalance demonstrations

#### 4. Recommendation Systems
- Why apps recommend videos/music  
- Activity: paper-based recommender system

#### 5. Creative AI & Media Literacy
- Deepfakes and synthetic media  
- Critical evaluation skills

### 6. Real-World AI Applications
- AI for climate, health, accessibility  
...
🔗 **High School Curriculum (MIT RAISE):**  
https://raise.mit.edu/day-of-ai/high-school

**Focus:** Technical ML concepts, Python-based labs, ethics, and societal issues.

#### 1. Foundations of AI
- Narrow vs. general AI  
- Data → model → deployment

#### 2. Hands-on Machine Learning (Python)
- Decision trees, KNN, simple neural nets  
...
#### 5. Ethics, Policy & Society
- Surveillance, fairness, data rights  
- Debate or policy proposal
...
- Deepfakes, AI art  
- Discussions on authenticity & copyright

---

### 🧭 Cross-Grade Optional Modules (Grades 5–12)

🔗 **Cross-Grade Modules & Extensions:**  
https://raise.mit.edu/day-of-ai

- Data & Bias Labs  
- Prompt Engineering Basics  
- AI & Careers (multi-grade slides)  

---

## 🧰 Difficulty & Pedagogy Summary

| Grade Level | Concept Depth | Coding Requirement | Ethics Emphasis |
|-------------|------------------------------|------------------|------------------|
| **Elementary** | Very introductory | None | Strong |
| **Middle School** | Applied understanding | Low/No code | Strong |
| **High School** | Technical + analytical | Python optional | Very strong |

---

## 📚 License and Availability

All Day of AI materials are:
- **Free**
- **Downloadable**
- **Reusable**
- **Adaptable for classroom use**

Materials are hosted through **MIT RAISE** and updated regularly.

## 🌍 Day of AI Global Program Hubs – Summary Table (as of 2025)

| **Country / Region** | **Launch Year** | **Estimated Students Reached** | **Teachers Trained** | **Local Adaptation** | **Strengths / Achievements** | **Challenges / Notes** |
|----------------------|------------------|-------------------------------|-----------------------|-----------------------|-------------------------------|-------------------------|
| **Australia** | 2022 | **121,485+ students** (cumulative) | Thousands (not publicly itemized) | Fully mapped to Australian National Curriculum; Australian examples and ethics cases | Largest, most mature hub; strong inclusivity focus; Student Challenge & Classroom Champions programs; national media visibility | Hardware access needs in low-SES/remote schools; teacher PD burden |
| **Colombia** | 2025 | *Projected:* tens of thousands (first year) | **900+ teacher-trainers** (2025) | Co-designed 3-lesson unit; aligned with national AI policy (CONPES 4144) | First nationwide Day of AI in Latin America; high government support; community-centered student projects | First rollout just beginning; actual participation numbers not yet published |
| **United States** | 2021 (pilot) | **Hundreds of thousands** (largest share of global >1M total) | Tens of thousands (cumulative) | Original MIT curriculum; English-language multi-grade modules | Flagship hub; wide teacher ecosystem; repeated annual adoption | Uneven access across districts; hardware and PD disparities |
| **United Kingdom** | 2023 | Not publicly reported | Not public | Optional mapping to UK curricula (KS2–KS4) | Growing adoption in STEM clubs and classrooms | No formal impact report yet |
| **Ireland** | 2023 | Not publicly reported | Not public | Adaptations aligned with Irish Digital Strategy for Schools | Strong tie-in with national digital literacy initiatives | Public metrics incomplete |
| **Hong Kong** | 2022 | Estimated thousands | Hundreds (various PD workshops) | Localized bilingual versions (English/Chinese) | Strong use in STEM enrichment and gifted programs | Participation varies between school types |
| **Singapore** | 2022 | Thousands (estimated) | Hundreds | Contextualized modules on AI in Singapore society | Strong government support; good digital infrastructure | No detailed public numbers |
| **New Zealand** | 2023 | Not public | Not public | Contextual examples; Māori data-ethics themes in some lessons | Good cross-curricular adoption in digital tech programs | No published quantitative data |
| **Vietnam** | 2023 | Not public | Not public | Translated content; adapted for uneven internet availability | Rapid NGO-supported expansion | Infrastructure and reporting limitations |
| **South Korea** | 2023 | Not public | Not public | Integrated into several digital education pilots | Tech-friendly uptake; strong student interest | No country-wide metrics |
| **Canada** | 2022 | Not public | Not public | Local contextualization in select provinces | Used in coding clubs and STEM camps | No national coordination; scattered adoption |
...
🌐 https://raise.mit.edu/day-of-ai  
📬 Contact: info@dayofai.org (listed on official site)
